...
require 'wkhtmltopdf/aml2/binary/version'

Gem::Specification.new do |spec|
  spec.name          = 'wkhtmltopdf-aml2-binary'
  spec.version       = Wkhtmltopdf::Aml2::Binary::VERSION
  spec.authors       = ['Sadat97']
  spec.email         = ['man@riskline.com']

  spec.summary       = 'wkhtmltopdf library binary files for amazon linux 2'
  spec.description   = 'wkhtmltopdf library binary files for amazon linux 2'
  ...
  spec.executables = ['wkhtmltopdf-linux-amd64']
